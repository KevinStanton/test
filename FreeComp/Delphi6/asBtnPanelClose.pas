...
type
	TasBtnPanelClose = class;

	TButtonOK = class(TPersistent)
  private
		FOwner: TasBtnPanelClose;
    FCaption: string;
	...
	public
		constructor Create(AOwner: TasBtnPanelClose);
	published
  ...
  private
	...
	TasBtnPanelClose = class(TCustomPanel)
  private
    FButtonOK: TButtonOK;
...
constructor TasBtnPanelClose.Create(AComponent: TComponent);
begin
...
procedure TasBtnPanelClose.Invalidate;
begin
  inherited;
  UpdateButtons;
end;

function TasBtnPanelClose.IsOnBtnApplyClickStored: Boolean;
begin
  Result := @OnBtnApplyClick <> nil;
end;

function TasBtnPanelClose.IsOnBtnCancelClickStored: Boolean;
begin
  Result := @OnBtnCancelClick <> nil;
end;

function TasBtnPanelClose.IsOnBtnCloseClickStored: Boolean;
begin
  Result := @OnBtnCloseClick <> nil;
end;

function TasBtnPanelClose.IsOnBtnHelpClickStored: Boolean;
begin
  Result := @OnBtnHelpClick <> nil;
end;

function TasBtnPanelClose.IsOnBtnOKClickStored: Boolean;
begin
  Result := @OnBtnOKClick <> nil;
end;

procedure TasBtnPanelClose.SetOnBtnApplyClick(const Value: TNotifyEvent);
begin
  FOnBtnApplyClick := Value;
  BtnApply.OnClick := Value;
end;

procedure TasBtnPanelClose.SetOnBtnCancelClick(const Value: TNotifyEvent);
begin
  FOnBtnCancelClick := Value;
  BtnCancel.OnClick := Value;
end;

procedure TasBtnPanelClose.SetOnBtnCloseClick(const Value: TNotifyEvent);
begin
  FOnBtnCloseClick := Value;
  BtnClose.OnClick := Value;
end;

procedure TasBtnPanelClose.SetOnBtnHelpClick(const Value: TNotifyEvent);
begin
  FOnBtnHelpClick := Value;
  BtnHelp.OnClick := Value;
end;

procedure TasBtnPanelClose.SetOnBtnOKClick(const Value: TNotifyEvent);
begin
  FOnBtnOKClick := Value;
  BtnOK.OnClick := Value;
end;

procedure TasBtnPanelClose.SetParentToForm(const Value: Boolean);
begin
...
procedure TasBtnPanelClose.UpdateButtons;
var
...
constructor TButtonOK.Create(AOwner: TasBtnPanelClose);
begin
  inherited Create;
  FOwner := AOwner;
end;
...
constructor TButtonClose.Create(AOwner: TasBtnPanelClose);
begin
  inherited Create;
  FOwner := AOwner;
end;
...
constructor TButtonCancel.Create(AOwner: TasBtnPanelClose);
begin
  inherited Create;
  FOwner := AOwner;
end;
...
constructor TButtonApply.Create(AOwner: TasBtnPanelClose);
begin
  inherited Create;
  FOwner := AOwner;
end;
...
constructor TButtonHelp.Create(AOwner: TasBtnPanelClose);
begin
  inherited Create;
  FOwner := AOwner;
end;
